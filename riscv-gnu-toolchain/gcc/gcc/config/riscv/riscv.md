...
;; === XTML custom instructions ===

(define_insn "riscv_tml_v<mode>"
  [(set (match_operand:X 0 "register_operand" "=r")
...
(define_insn "riscv_tml_tb<mode>"
  [(unspec_volatile [(match_operand:X 0 "register_operand" "r")
                     (match_operand:X 1 "register_operand" "r")]
                    UNSPECV_TML_TB)]
  "TARGET_XTML"
  "tml.tb\tx0,%0,%1"
