...
riscv_cpu_cpp_builtins (cpp_reader *pfile)
{
  ...
  if (TARGET_XTML)
    {
      builtin_define ("__riscv_xtml=10000");   /* 1.0.0 → 10000 */
      builtin_define ("__riscv_xtml_major=1");
      builtin_define ("__riscv_xtml_minor=0");
      builtin_define ("__riscv_xtml_patch=0");
    }
