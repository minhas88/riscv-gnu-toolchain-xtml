...
/* XTML custom extension: backend-wide boolean set during -march parsing. */
/* Note: riscv_has_xtml is defined by the option system in riscv.opt */

/* Target predicate used in MD conditionals and codegen. */
#define TARGET_XTML (riscv_has_xtml)
