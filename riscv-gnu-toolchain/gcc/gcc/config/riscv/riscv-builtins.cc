...
AVAIL (hint_pause, (!0))
AVAIL (xtml, (!0))  // Always register TML builtins; availability checked in MD patterns
...
static const struct riscv_builtin_description riscv_builtins[] = {
  ...
  /* TML Custom Instructions */
  RISCV_BUILTIN (tml_vsi, "tml_v", RISCV_BUILTIN_DIRECT, RISCV_USI_FTYPE_USI_USI, xtml),
  RISCV_BUILTIN (tml_hsi, "tml_h", RISCV_BUILTIN_DIRECT, RISCV_USI_FTYPE_USI_USI, xtml),
  RISCV_BUILTIN (tml_tbsi, "tml_tb", RISCV_BUILTIN_DIRECT_NO_TARGET, RISCV_VOID_FTYPE_USI_USI, xtml),
};
